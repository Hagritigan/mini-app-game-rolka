    ...
    <Panel id={id}>
      <div className="rules-panel">
        ...
        <Group>
            ...
            <br />
            <br />
            Боевых ботов можно приобрести за награду&nbsp;<span onClick={() => routeNavigator.push({ pathname: '/rules/pirates' })} className="link">пиратов</span>, в качестве награды за звания у Дозора и РА. На бота можно отдать слот способности, в таком случае, сила бота будет равна 75%.
            ...
            <div align="left">Что касается фруктов, то, <span onClick={() => routeNavigator.push({pathname: '/rules/abilities'})} className='link'>по разделу способностей</span>, вы уже знаете, 
            какие типы имеются. В нашей ролевой <span onClick={() => routeNavigator.push({pathname: '/rules/restrictions'})} className='link'>можно взять и пользоваться каноническими 
            ...
            <br />
            <br />
            <center><div><span onClick={() => routeNavigator.push('/inventory/0')} className='link'>&bull; Список легендарных мечей</span>&nbsp;<a href="https://vk.com/page-36291248_54971895" className='link' target='_blank' rel="noopener noreferrer">&bull; Список занятых дьявольских фруктов &bull;</a></div></center>
